...
const lessonsHK1 = [
  ...
  { title: 'Bài 4. Tìm kiếm và trao đổi thông tin', icon: <Search size={32} color="#1976d2" />, color: 'primary', link: '/scorm/Bai04L4/res/index.html' },
  ...
  { title: 'Ôn tập kiểm tra học kì I', icon: <ShieldCheck size={32} color="#1976d2" />, color: 'error' },
];

const lessonsHK2 = [
  { title: 'Bài 7. Tạo bài trình chiếu', icon: <Image size={32} color="#1976d2" />, color: 'primary', link: '/scorm/Bai07L4/res/index.html' },
  { title: 'Bài 8. Định dạng văn bản trên trang chiếu', icon: <Type size={32} color="#1976d2" />, color: 'success', link: '/scorm/Bai08L4/res/index.html' },
  { title: 'Bài 9. Hiệu ứng chuyển trang', icon: <Film size={32} color="#1976d2" />, color: 'warning', link: '/scorm/Bai09L4/res/index.html' },
  { title: 'Bài 10. Phần mềm soạn thảo văn bản', icon: <FileText size={32} color="#1976d2" />, color: 'primary', link: '/scorm/Bai10L4/res/index.html' },
  { title: 'Bài 11. Chỉnh sửa văn bản', icon: <Edit size={32} color="#1976d2" />, color: 'success', link: '/scorm/Bai11L4/res/index.html' },
  { title: 'Bài 12A. Thực hành đa phương tiện', icon: <Video size={32} color="#1976d2" />, color: 'warning', link: '/scorm/Bai12AL4/res/index.html' },
  { title: 'Bài 12B. Phần mềm luyện gõ bàn phím', icon: <Keyboard size={32} color="#1976d2" />, color: 'primary', link: '/scorm/Bai12BL4/res/index.html' },
  { title: 'Bài 13. Chơi với máy tính', icon: <Gamepad size={32} color="#1976d2" />, color: 'success', link: '/scorm/Bai13L4/res/index.html' },
  { title: 'Bài 14. Khám phá môi trường lập trình trực quan', icon: <Code size={32} color="#1976d2" />, color: 'warning', link: '/scorm/Bai14L4/res/index.html' },
  ...
  { title: 'Ôn tập kiểm tra học kì II', icon: <ShieldCheck size={32} color="#1976d2" />, color: 'error' },
];
