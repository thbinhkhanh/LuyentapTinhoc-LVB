...
const lessonsHK1 = [
  ...
  { title: 'Ôn tập kiểm tra học kì I', icon: <ShieldCheck size={32} color="#1976d2" />, color: 'error', link: '/scorm/OntapHKIL5/res/index.html' },
];
...
const lessonsHK2 = [
  ...
  { title: 'Ôn tập kiểm tra học kì II', icon: <ShieldCheck size={32} color="#1976d2" />, color: 'error', link: '/scorm/OntapHKIIL5/res/index.html' },
];
